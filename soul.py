...
TOKEN = '7551881585:AAFdiFh-rmoKkFRjQv2RtgXqMJoePNKogYE'
MONGO_URI = 'mongodb+srv://Soul:JYAuvlizhw7wqLOb@soul.tsga4.mongodb.net'
CHANNEL_ID = 920262785
...
def attack_command(message):
    ...
    try:
        ...
        if user_data['plan'] == 2 and users_collection.count_documents({"plan": 2}) > 499999:
            bot.send_message(chat_id, "Your Instant++ Plan 💥 is currently not available due to limit reached.")
            return
...
def main():
    ...
    logging.info("Starting hellbot activity keeper and hellbot...")
    while True:
        try:
